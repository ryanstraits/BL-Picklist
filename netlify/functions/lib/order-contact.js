// Maps a full BrickLink order detail (GET /orders/{id}) to the flat
// buyer-contact shape the order detail page needs — the list endpoint
// (GET /orders) doesn't carry buyer_email, shipping.address, or
// payment.method at all, only the per-order detail call does.
